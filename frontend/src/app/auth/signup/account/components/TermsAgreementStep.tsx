  ...
  return (
    ...
    >
      ...
      <Typography>
        ...
        [Platform Name] (the "Service") operated by [Your Company Name] ("us", "we", or "our").
      ...
      <Typography>
        1. Accounts When you create an account with us, you must provide us with information that is
      ...
      <Typography>
        2. 2FA Setup For enhanced security, you are required to set up two-factor authentication
        (2FA) during the registration process. This involves linking an authenticator app to your
        account and providing a verification code each time you log in. Failure to complete this
        step will prevent access to the Service.
      </Typography>
      <Typography>
        3. Intellectual Property The Service and its original content, features, and functionality
        are and will remain the exclusive property of [Your Company Name] and its licensors. The
        ...
        product or service without the prior written consent of [Your Company Name].
      </Typography>
      <Typography>
        4. Termination We may terminate or suspend your account immediately, without prior notice or
        liability, for any reason whatsoever, including without limitation if you breach the Terms.
        Upon termination, your right to use the Service will immediately cease. If you wish to
        terminate your account, you may simply discontinue using the Service.
      </Typography>
      <Typography>
        5. Limitation of Liability In no event shall [Your Company Name], nor its directors,
        ...
        of profits, data, use, goodwill, or other intangible losses, resulting from (i) your use or
        inability to use the Service; (ii) any unauthorized access to or use of our servers and/or
        any personal information stored therein; (iii) any interruption or cessation of transmission
        to or from the Service; (iv) any bugs, viruses, trojan horses, or the like that may be
        transmitted to or through our Service by any third party; and (v) any errors or omissions in
        any content or for any loss or damage incurred as a result of the use of any content posted,
        emailed, transmitted, or otherwise made available through the Service, whether based on
        warranty, contract, tort (including negligence), or any other legal theory, whether or not
        we have been informed of the possibility of such damage, and even if a remedy set forth
        herein is found to have failed of its essential purpose.
      </Typography>
      <Typography>
        6. Governing Law These Terms shall be governed and construed in accordance with the laws of
        [Your State/Country], without regard to its conflict of law provisions. Our failure to
        enforce any right or provision of these Terms will not be considered a waiver of those
        rights. If any provision of these Terms is held to be invalid or unenforceable by a court,
      ...
      <Typography>
        7. Changes We reserve the right, at our sole discretion, to modify or replace these Terms at
      ...
      <Typography>
        8. Contact Us If you have any questions about these Terms, please contact us at: [Your
        Contact Information]
      </Typography>
    </Stack>
  );
